...
{
 "use strict";
 var Global,WebSharper,Remarkable,RenderingTest,Client,UI,Next,Doc,Operators,JavaScript,Pervasives,AttrProxy,DomUtility,Client$1,DocNode,View,Unchecked,Array,Elt,DocElemNode,Snap,SC$1,Docs,Abbrev,Mailbox,Arrays,List,T,Attrs,Var,Attrs$1,Dyn,Docs$1,RunState,NodeSet,An,Async,Enumerator,SC$2,Fresh,Collections,HashSet,Concurrency,Anims,AppendList,T$1,Seq,SC$3,HashSet$1,SC$4,Scheduler,SC$5,Easing,DomNodes,OperationCanceledException,CancellationTokenSource,HashSetUtil,SC$6,Lazy,IntelliFactory,Runtime;
 Global=window;
 ...
 Client.Main=function()
 {
  ...
  t=(a=[Doc.TextNode("# Test text")],Doc.Element("div",[],a));
  Doc.RunById("main",t);
 };
